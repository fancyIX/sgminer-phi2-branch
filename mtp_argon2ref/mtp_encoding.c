...
/*
 * Example code for a decoder and encoder of "hash strings", with MTPArgon2
 * parameters.
 *
 ...
 *
 *   -- The second section is specific to MTPArgon2. It encodes and decodes
...
/* ==================================================================== */
/*
 * Code specific to MTPArgon2.
 *
 * The code below applies the following format:
 *
 *  $mtp_argon2<T>[$v=<num>]$m=<num>,t=<num>,p=<num>$<bin>$<bin>
 *
...
#define BIN(buf, max_len, len)                                                 \
    ...
    /* We should start with the mtp_argon2_type we are using */
    type_string = mtp_argon2_type2string(type, 0);
    if (!type_string) {
    ...
    ctx->version = MTP_ARGON2_VERSION_10;
