...
#define MTP_ARGON2_MAX_DECODED_LANES UINT32_C(255)
#define MTP_ARGON2_MIN_DECODED_SALT_LEN UINT32_C(8)
#define MTP_ARGON2_MIN_DECODED_OUT_LEN UINT32_C(12)

/*
* encode an MTPArgon2 hash string into the provided buffer. 'dst_len'
* contains the size, in characters, of the 'dst' buffer; if 'dst_len'
* is less than the number of required characters (including the
* terminating 0), then this function returns MTP_ARGON2_ENCODING_ERROR.
*
...
/*
* Decodes an MTPArgon2 hash string into the provided structure 'ctx'.
...
size_t mtp_numlen(uint32_t num);
