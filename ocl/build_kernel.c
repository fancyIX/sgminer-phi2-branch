...
{
  char buf[255];
  sprintf(data->compiler_options, "-I \"%s\" -I \"%s/kernel\" -I \".\" -D WORKSIZE=%d -D WORKSIZE2=%d -DWORKSIZE8=%d",
      data->sgminer_path, data->sgminer_path, (int)data->work_size, ((int)data->work_size), ((int)data->work_size));
